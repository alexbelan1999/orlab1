...
for i in range(0,G1.number_of_nodes()-1):
    if i == 0:
        ...
        if flag3 == True:
            Skeleton.add_node(edges_with_weight1[min_edge][1])
            print('node ' + str(edges_with_weight1[min_edge][1]))
        if flag4 == True:
            Skeleton.add_node(edges_with_weight1[min_edge][0])
            print('node ' + str(edges_with_weight1[min_edge][0]))
...
print(Skeleton.number_of_nodes())
print(Skeleton.number_of_edges())
print(edges_with_weight2)
